...
public class PackageHook implements IXposedHookLoadPackage {
	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
		...
		XposedHelpers.findAndHookMethod(scrimcontrollerclass, "applyExpansionToAlpha", new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				XposedHelpers.setBooleanField(scrimcontrollerclass, "mExpansionAffectsAlpha", false);
				param.setResult(null);
			}
		});
		/*XposedHelpers.findAndHookMethod(scrimcontrollerclass, "setOrAdaptCurrentAnimation", View.class, new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
		...
		XposedHelpers.findAndHookMethod(scrimcontrollerclass, "updateScrimColor", View.class, float.class, int.class, new XC_MethodHook() {
			@Override
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				if (!XposedHelpers.findField(scrimcontrollerclass, "mScrimBehind").get(param.thisObject).equals(param.args[0])) return;
